...
export default class CustomizerEditor extends React.Component {
    ...
    renderNewSection() {
        if(this.state.addNewSection) {
            return (
                <div>
                    <input placeholder="New section name" value={this.state.newSectionTitle} onChange={this.handleSectionTitleChange} />
                    <Button buttonType="primary" innerText="Create New Section" click={this.createNewSection} />
                </div>
            )
        } else {
            return (
                <Button buttonType="primary" innerText="Create New Section" click={this.toggleAddNewSection}/>
            )
        }
    }
